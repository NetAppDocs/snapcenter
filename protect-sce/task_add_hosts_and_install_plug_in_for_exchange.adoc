 ...
 ** Exchange DAG
+
For an Exchange DAG, you can do the following:
...
[NOTE]
 For a stand-alone host or an Exchange DAG (cross-domain or same domain), it is recommended to provide FQDN or the IP address of the host.
