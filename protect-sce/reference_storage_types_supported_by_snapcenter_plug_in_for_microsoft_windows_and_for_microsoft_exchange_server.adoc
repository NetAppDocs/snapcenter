...
SnapCenter provisioning and data protection support is available on Windows Server. For the latest information about supported versions, see the https://imt.netapp.com/imt/imt.jsp?components=180321;180339;180327;&solution=1257&isHWU&src=IMT[NetApp Interoperability Matrix Tool^].
