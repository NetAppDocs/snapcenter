...
+
Click image:../media/filter_icon.png[Filter icon] and select the host name and the Exchange Server to filter the resources. You can then click image:../media/filter_icon.png[Filter icon] to close the filter pane.
