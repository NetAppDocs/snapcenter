...
+
Click image:../media/filter_icon.png[] and select the host name and the Exchange Server to filter the resources. You can then click image:../media/filter_icon.png[] to close the filter pane.
