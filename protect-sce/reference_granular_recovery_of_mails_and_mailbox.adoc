...
* https://kb.netapp.com/Legacy/SMBR/How_to_manually_restore_a_single_item_with_SMBR[How to manually restore a single item with SMBR using Ontrack Power Control]
