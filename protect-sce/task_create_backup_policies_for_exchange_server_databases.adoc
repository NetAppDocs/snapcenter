...
+
NOTE: Select both the secondary replication options for *Secondary snapshot copy locking period* to be effective. This option is available in the Retention page.
+
|===
| For this field...| Do this...
