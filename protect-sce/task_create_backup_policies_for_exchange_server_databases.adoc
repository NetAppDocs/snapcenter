...
You can set *Number of full backups for which logs are retained* value as 0, if you do not want perform up-to-the-minute restore. This will enable point-in-time restore operation.
