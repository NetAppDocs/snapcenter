---
permalink: protect-sce/task_configure_gMSA_on_windows_server_2012_or_later_for_exchange_server.html
sidebar: sidebar
keywords:
...
---
= Configure group Managed Service Account on Windows Server 2012 or later for exchange server
:icons: font
:imagesdir: ../media/
