...
* Adding new databases to an existing resource group in failover mode is not supported. You can add resources to the resource group only in regular or fail-back state.
