---
permalink: protect-scw/task_configure_gMSA_on_windows_server_2012_or_later_for_plugin_for_windows.html
sidebar: sidebar
keywords:
...
---
= Configure gMSA on Windows Server 2012 or later for Plug-in for Windows
:icons: font
:imagesdir: ../media/
