...
link:../admin/index.html[Manage SnapCenter Server and plug-ins] section has more information on managing hosts.
...
[NOTE]
credentials authentication mode is determined by the host type that you specify in the Add Host wizard.
