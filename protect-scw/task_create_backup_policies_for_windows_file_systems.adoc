...
+
link:task_define_a_backup_strategy_for_windows_file_systems.html[Define a backup strategy for Windows file systems]
...
+
For information about how administrators assign resources to users, see link:../admin/index.html[Manage SnapCenter Server and plug-ins].
