---
permalink: protect-db2/task_add_hosts_and_install_plug_in_packages_on_remote_hosts_ibm_db2.html
sidebar: sidebar
...
+
link:../protect-db2/task_configure_gMSA_on_windows_server_2012_or_later.html[Configure group Managed Service Account on Windows Server 2012 or later for IBM Db2^]
