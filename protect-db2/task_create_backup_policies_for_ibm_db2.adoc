---
permalink: protect-db2/task_create_backup_policies_for_ibm_db2.html
sidebar: sidebar
...
[.lead]
Before you use SnapCenter to back up IBM Db2 database resources, you must create a backup policy for the resource or resource group that you want to back up. A backup policy is a set of rules that governs how you manage, schedule, and retain backups.
