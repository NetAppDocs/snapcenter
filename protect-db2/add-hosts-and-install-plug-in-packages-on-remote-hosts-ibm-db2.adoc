...
+
link:../protect-db2/configure_gMSA_on_windows_server_2012_or_later.html[Configure group Managed Service Account on Windows Server 2016 or later for IBM Db2^]
...
If you want to upgrade to SnapCenter 6.0 version, the existing PERL-based Plug-in for Db2 will be uninstalled from the remote plug-in server.
