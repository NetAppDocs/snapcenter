...
* You must have installed Java 17, Java 11 (for SnapCenter 6.2 only) on your host.
+
...
* You must have installed Java 17, Java 11 (for SnapCenter 6.2 only) on your Windows host.
+
...
* You must have installed Java 17, Java 11 (for SnapCenter 6.2 only) on your Linux or AIX hosts.
+
