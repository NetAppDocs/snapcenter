...
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html[Download JAVA for Windows^]

== Linux and AIX hosts

* You must have enabled the password-based SSH connection for the root or non-root user.

* You must have installed Java 11 on your Linux or AIX hosts.
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html[Download JAVA for Linux^]
+
