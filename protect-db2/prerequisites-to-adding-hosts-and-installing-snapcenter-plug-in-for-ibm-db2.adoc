...
* You must have installed Java 17 (Oracle Java, OpenJDK, or SAP JDK) for SnapCenter 6.2.1 and later or Java 11 for SnapCenter 6.2 and earlier on your Linux or AIX hosts.
+
link:https://www.oracle.com/java/technologies/downloads/#java17[Download Java for Linux^]
+
link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM[Download Java for AIX^]
