...
+
link:https://www.oracle.com/java/technologies/downloads/#java11-windows[Download JAVA for Windows]
...
+
link:https://www.oracle.com/java/technologies/downloads/#java11-linux[Download JAVA for Linux]
+
