...
* You must have installed Java 17 (or Java 11 for SnapCenter 6.2) on your host.
+
...
* You must have installed Java 17 (or Java 11 for SnapCenter 6.2) on your Windows host.
+
...
* You must have installed Java 17 (or Java 11 for SnapCenter 6.2) on your Linux or AIX hosts.
+
