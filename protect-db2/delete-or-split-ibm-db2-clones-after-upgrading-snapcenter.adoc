...
. Select the clones, and then click image:../media/delete_icon.gif[delete icon]elete icon] to delete clones or click image:../media/split_clone.gif[split clone] to split the clones.
. Click *OK*.
