...
---
= Add hosts and install SnapCenter Plug-in for Microsoft SQL Server Database
:icons: font
:imagesdir: ../media/

[.lead]
You must use the SnapCenter *Add Host* page to add hosts and install the plug-in. The plug-ins are automatically installed on the remote hosts.
