...
+
Click image:../media/filter_icon.png[filter icon] and select the host name and the SQL Server Instance to filter the resources. You can then click image:../media/filter_icon.png[filter icon] to close the filter pane.
