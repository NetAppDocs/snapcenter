...
For ONTAP and application plug-in minimum requirements see https://mysupport.netapp.com/matrix/imt.jsp?components=100747;&solution=1257&isHWU&src=IMT[Interoperability Matrix Tool^]

|===
|Hosts |Minimum requirements

a|Operating System (64-bit)
a|See https://mysupport.netapp.com/matrix/imt.jsp?components=100747;&solution=1257&isHWU&src=IMT[Interoperability Matrix Tool^]
