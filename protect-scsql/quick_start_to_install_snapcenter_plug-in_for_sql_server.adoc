...
---
= Install SnapCenter Plug-in for SQL Server
:icons: font
:imagesdir: ../media/
...
For ONTAP and application plug-in minimum requirements see http://mysupport.netapp.com/matrix[Interoperability Matrix Tool^]
...
== Add a host and installing the Plug-in for Microsoft SQL Server
