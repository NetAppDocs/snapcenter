...
.. Select image::../media/filter_icon.png[filter icon], and then select the host name to filter the instances.
.. Select image::../media/filter_icon.png[filter icon] to close the filter pane.
