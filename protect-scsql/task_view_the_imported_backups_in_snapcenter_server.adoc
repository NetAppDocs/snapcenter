...
+
NOTE: Once the archived Snapshot copies are migrated and they get cleaned up from the storage as part of the secondary retention, the respective primary Snapshot copies that are created in SnapManager must be cleaned up manually.
//BURT 1444012
