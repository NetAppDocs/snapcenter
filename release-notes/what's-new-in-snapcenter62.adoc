...
The 6.2.1 release of SnapCenter software has no new features. It includes only bug fixes and updates of the qualified versions for the SnapCenter Server and plug-ins. Refer to the link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467[SnapCenter 6.2.1 Release Notes^] for further details.
