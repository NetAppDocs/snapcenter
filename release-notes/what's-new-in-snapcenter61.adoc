...
a|
SnapCenter 6.2 (server and plug-ins) along with ONTAP 9.17.1 supports data protection of applications running on physical systems and Virtual Machine File Systems (VMFS) on ASA r2 systems utilizing hierarchical consistency groups for both primary and replication.
