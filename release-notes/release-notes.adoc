...
For details about known issues, limitations, fixed issues, and new and changed commands, see the https://library.netapp.com/ecm/ecm_download_file/ECMLP3337665[SnapCenter Software 6.2 Release Notes^]. You must sign in with your NetApp account or create an account to access the Release Notes.