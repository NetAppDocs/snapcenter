...
NOTE: After you upgrade to SnapCenter 6.2.1 (server and plug-ins) and ONTAP 9.17.1, SnapCenter changes flat consistency groups to hierarchical consistency groups during the first scheduled backup.
