...
For information on SnapCenter REST APIs, see link:/sc-automation/automation_index.html[SnapCenter Automation^]

* link:https://sc-automation/automation_index.html[SnapCenter Automation]

* xref:/sc-automation/automation_index.adoc[SnapCenter Automation]

* xref:sc-automation/automation_index.adoc[SnapCenter Automation]

* xref:/sc-automation/automation_index.html[SnapCenter Automation]

* xref:sc-automation:automation_index.adoc[SnapCenter Automation]

sc-automation/automation_index.html
