...
** Data that is on ONTAP FAS, AFF, or ASA primary & secondary systems and protected to local StorageGRID object storage (using NetApp BlueXP cloud backup integration)
...
** Data that is on ONTAP FAS, AFF, or ASA primary and secondary systems and protected to object and archive storage in cloud (using NetApp BlueXP Cloud Backup integration)
