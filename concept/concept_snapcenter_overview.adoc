...
+
SM-BC is supports SAN configurations. It also supports AFF clusters or All SAN Array (ASA) clusters, where the primary and secondary clusters can be either AFF or ASA. It is not supported on CVO or FSx.
+
