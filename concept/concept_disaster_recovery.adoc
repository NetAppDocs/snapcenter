...
* SnapCenter disaster recovery functionality uses REST APIs to backup SnapCenter Server. See link:../sc-automation/rest_api_workflows_disaster_recovery_of_snapcenter_server.html[REST API workflows for disaster recovery of SnapCenter Server].
