...
+
You can search the resource group either by entering the resource group name in the search box, or by clicking image:../media/filter_icon.png[filter icon], and then selecting the tag. You can then click image:../media/filter_icon.png[filter icon] to close the filter pane.
