...
+
You can only create offline-mount backups of Data Guard standby databasess. Offline-shutdown backup, archive log only backup, and full backup are not supported.
