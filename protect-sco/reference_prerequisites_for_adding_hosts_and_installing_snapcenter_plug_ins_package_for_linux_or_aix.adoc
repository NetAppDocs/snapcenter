...
For information, see link:../protect-sco/reference_prerequisites_for_adding_hosts_and_installing_snapcenter_plug_ins_package_for_linux_or_aix.html#host_requirements_for_installing_the_snapcenter_plug_in_package_for_linux##configuring-sudo-privileges-for-non-root-users-for-linux-plug-in-host[Configure sudo privileges for Linux host^] or link:../protect-sco/reference_prerequisites_for_adding_hosts_and_installing_snapcenter_plug_ins_package_for_linux_or_aix.html#host_requirements_for_installing_the_snapcenter_plug_ins_package_for_aix##configure-sudo-privileges-for-non-root-user-for-aix-plug-in-host[Configure sudo privileges for AIX host^].
