...
----
+
NOTE: If you are having a RAC setup, along with the other lines, you should add the following line to the /etc/sudoers file:
`LINUX_USER ALL=(ALL) NOPASSWD:SETENV: HPPLCMD, PRECHECKCMD, CONFIGCHECKCMD, SCCCMDEXECUTOR, SCCMD, /<crs_home>/bin/olsnodes`
...
+
NOTE: If you are having a RAC setup, along with the other lines, you should add the following line to the /etc/sudoers file:
`AIX_USER ALL=(ALL) NOPASSWD:SETENV: HPPLCMD, PRECHECKCMD, CONFIGCHECKCMD, SCCCMDEXECUTOR, SCCMD, /<crs_home>/bin/olsnodes`
