...
* You must have installed Java 17 (or Java 11 for SnapCenter 6.2) on your Linux or AIX host.
...
+
NOTE: Ensure that you have installed only the certified edition of Java 17 (or Java 11 for SnapCenter 6.2) on the Linux host.
...
a|
Java 17 (Oracle or OpenJDK) (or Java 11 for SnapCenter 6.2)
...
Required software packages
a|
Java 17 IBM Java (or Java 11 for SnapCenter 6.2)
