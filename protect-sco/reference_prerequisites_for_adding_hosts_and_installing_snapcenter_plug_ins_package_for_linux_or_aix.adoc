...
* Java 11 (for SnapCenter 6.2 and earlier) on your Linux or AIX host.
...
Required software packages
a|
* IBM Java 17 for SnapCenter 6.2.1 and later or
* IBM Java 11 for SnapCenter 6.2 and earlier
