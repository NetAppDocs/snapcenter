...
* You must have installed Java 17, Java 11 (for SnapCenter 6.2 only) on your Linux or AIX host.
...
+
NOTE: Ensure that you have installed only the certified edition of Java 17, Java 11 (for SnapCenter 6.2 only) on the Linux host.
...
a|
Java 17 (Oracle or OpenJDK), Java 11 (for SnapCenter 6.2 only)
...
Required software packages
a|
IBM Java 17, IBM Java 11 (for SnapCenter 6.2 only)
