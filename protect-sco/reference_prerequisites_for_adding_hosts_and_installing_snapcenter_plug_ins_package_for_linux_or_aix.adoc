...
* Java 11 (64-bit) Oracle Java and OpenJDK
...
For the latest information about supported versions, see the https://imt.netapp.com/matrix/imt.jsp?components=117016;&solution=1259&isHWU&src=IMT[NetApp Interoperability Matrix Tool^].
