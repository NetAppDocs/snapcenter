...
+
For detailed information on UNIX commands, see the https://library.netapp.com/ecm/ecm_download_file/ECMLP2885486[SnapCenter Software Command Reference Guide^].
