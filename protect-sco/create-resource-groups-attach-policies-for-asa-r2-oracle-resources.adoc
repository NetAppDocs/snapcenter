---
permalink: protect-sco/create-resource-groups-attach-policies-for-asa-r2-oracle-resources.html
sidebar: sidebar
keywords: run as
...
= Create resource groups and attach policies for ASA r2 Oracle resources
:icons: font
:imagesdir: ../media/

[.lead]
You should create the resource group to add the Oracle resources that are on ASA r2 systems.
