---
permalink: protect-sco/alternate-methods-install-plug-in-linux-aix.html
sidebar: sidebar
keywords: other methods, install, plug-ins package, linux, aix, remote hosts, cmdlets, cluster host, silent mode, console mode
...
= Alternate methods to install Plug-ins Package for Linux or AIX
You can use other alternate methods to install the plug-ins package for Linux or AIX
