...
+
For SnapMirror Business Continuity (SM-BC), after failover and failback, clicking the *Refresh* button refreshes the mirror copies. A weekly schedule also refreshes the mirror copies.
+
...
Alternatively, you can also refer to the https://library.netapp.com/ecm/ecm_download_file/ECMLP2886206[SnapCenter Software Command Reference Guide^] or https://library.netapp.com/ecm/ecm_download_file/ECMLP2886205[SnapCenter Software Cmdlet Reference Guide^].
