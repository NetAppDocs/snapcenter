...
* If you have an Automatic Storage Management (ASM) database instance in an NFS environment and want to mount the ASM backups, you should have added the ASM disk path _/var/opt/snapcenter/sco/backup_*/*/*/*/*_ to the existing path defined in the asm_diskstring parameter.
* If you have an ASM database instance in an NFS environment and want to mount the ASM log backups as part of a recovery operation, you should have added the ASM disk path _/var/opt/snapcenter/scu/clones/*/*_ to the existing path defined in the asm_diskstring parameter.
...
You can run the following command to retrieve the information related to the mounted backup: `./sccli Get-SmBackup -BackupName backup_name -ListMountInfo`
