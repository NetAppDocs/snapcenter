...
a|
Select the check box if you want to create temporary tablespaces for Oracle database.

If the check box is not selected, the cloned database will be created without temporary tablespaces.
a|
...
* https://kb.netapp.com/Advice_and_Troubleshooting/Data_Protection_and_Security/SnapCenter/ORA-00308%3A_cannot_open_archived_log_ORA_LOG_arch1_123_456789012.arc[Cloning fails with the message "ORA-00308: cannot open archived log '/ORA_LOG/arch1__123_456789012.arc^]
