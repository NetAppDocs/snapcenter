...
* Create credentials with authentication mode as Linux or AIX for the install user. link:../protect-sco/task_set_up_credentials_for_installing_the_plug_in_package_for_linux_or_aix.html[Learn more^]
...
+
See link:../protect-sco/reference_host_requirements_for_installing_the_snapcenter_plug_in_package_for_linux.html[Linux host requirements^] or link:../protect-sco/reference_host_requirements_for_installing_the_snapcenter_plug_ins_package_for_aix.html[AIX host requirements^] for more information.
