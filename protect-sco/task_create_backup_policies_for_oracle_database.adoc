...
+
For ONTAP 9.12.1 and below versions, the clones created from the SnapLock Vault Snapshot copies will inherit the SnapLock Vault expiry time. Storage admin should manually cleanup the clones post the SnapLock expiry time.
+
