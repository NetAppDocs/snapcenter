...
The https://imt.netapp.com/matrix/imt.jsp?components=108392;&solution=1259&isHWU&src=IMT[NetApp Interoperability Matrix Tool] contains the latest information about the supported versions.
