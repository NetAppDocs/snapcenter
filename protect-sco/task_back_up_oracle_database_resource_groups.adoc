...
. Enter the resource group name in the search box, or click the Filter icon image:../media/filter_icon.gif[Filter icon], and select the tag.
+
Click the Filter icon image:../media/filter_icon.gif[Filter icon] to close the filter pane.
