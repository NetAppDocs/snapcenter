...
The configurations that are supported with the SnapCenter Plug-in for Oracle Database are listed in the https://imt.netapp.com/imt/imt.jsp?components=180320;180338;180332;&solution=1257&isHWU&src=IMT[NetApp Interoperability Matrix Tool^].
