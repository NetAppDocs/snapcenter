...
+
----
PS C:\> New-SmClone -Resources @{"Host"="10.32.212.13";"Uid"="mysqlinst1\BOOKS"} -BackupName 'scmysql01_gdl_openlab_netapp_local_MySQL_mysqlinst1_BOOKS_scmysql01_05-15-2024_00.29.20.1466' -AppPluginCode MySQL -CloneToInstance '10.32.212.14' -CloneInstance mysqlinst1 -CloneName BOOKS
----
+
