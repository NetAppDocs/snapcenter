...
For the latest information about supported versions, see the For the latest information about supported versions, see the https://imt.netapp.com/imt/imt.jsp?components=180320;180338;&solution=1257&isHWU&src=IMT[NetApp Interoperability Matrix Tool].
