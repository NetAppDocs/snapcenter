...
+
You can search the resource group either by entering the resource group name in the search box or by selecting image:../media/filter_icon.gif[filter icon]ilter icon], and then selecting the tag. You can then select image:../media/filter_icon.gif[filter icon] to close the filter pane.
