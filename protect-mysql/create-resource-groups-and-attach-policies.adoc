...
|===
+
image:../media/application_settings.gif[application setting]
...
|===
+
NOTE: The custom key-value pairs are supported for MySQL Linux plug-in systems and not supported for MySQL database registered as a centralized windows plug-in.
