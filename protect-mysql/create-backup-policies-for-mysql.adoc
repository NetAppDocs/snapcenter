...
summary: 'Before you use SnapCenter to back up postgresql database resources, you must create a backup policy for the resource or resource group that you want to back up. A backup policy is a set of rules that governs how you manage, schedule, and retain backups.'
---
...
+
For details, see the information about defining a data protection strategy for postgresql databases.
