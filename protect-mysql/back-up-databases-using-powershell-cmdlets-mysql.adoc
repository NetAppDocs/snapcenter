...
+
----
C:\PS> New-SMBackup -ResourceGroupName 'ResourceGroup_wback-up-databases-using-powershell-cmdlets-mysql.adocith_SingleContainer_MultipleContainers_Resources'  -Policy mysql_policy1
----
+
