...
* You must have installed Java 17 (Oracle Java, OpenJDK, or SAP JDK) for SnapCenter 6.2.1 and later or Java 11 for SnapCenter 6.2 and earlier on your host.
+
...
* If you are using MySQL version earlier than 8.0, you should manually install and enable the MySQLX plug-in. The MySQLX plug-in is installed and enabled by default for MySQL 8.0 or later.
...
* You must have installed Java 17 (Oracle Java, OpenJDK, or SAP JDK) for SnapCenter 6.2.1 and later or Java 11 for SnapCenter 6.2 and earlier on your Windows host.
+
link:https://www.oracle.com/java/technologies/downloads/#java17[Download Java for all operating systems]
