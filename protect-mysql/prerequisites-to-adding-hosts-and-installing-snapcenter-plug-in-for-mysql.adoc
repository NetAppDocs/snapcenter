...
* If you are using MySQL version earlier than 8.0, you should manually enable the MySQLX plug-in. The MySQLX plug-in installed by default for MySQL 8.0 or later.
