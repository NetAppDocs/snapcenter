...
If the number of Snapshots exceeds the specified number, the oldest Snapshots are deleted first.

NOTE: The maximum retention value is 1018. Backups will fail if retention is set to a value higher than what the ONTAP version supports.
