...
* To create SAP HANA system replication backups, it is recommended to add all the resources of that system into one resource group. This ensures a seamless backup during takeover-failback mode.
+
