...
+
The https://imt.netapp.com/imt/imt.jsp?components=180320;180336;&solution=1257&isHWU&src=IMT[Interoperability Matrix Tool (IMT)] contains the latest information about the supported configurations.
