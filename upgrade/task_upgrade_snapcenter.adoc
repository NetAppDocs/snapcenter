...
* #You should back up the SnapCenter repository (MySQL) database after ensuring that no jobs are running. This is necessary before upgrading SnapCenter Server and the Exchange plug-in#.
+
