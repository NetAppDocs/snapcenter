...
* Ensure that ASP.NET Core Runtime 8.0.24 (and all subsequent 8.0.x patches) Hosting Bundle and PowerShell 7.4.13 or later are installed on the Windows plug-in host.
* Ensure that Java 17 (Oracle Java or OpenJDK) for SnapCenter 6.2.1 and later or Java 11 for SnapCenter 6.2 and earlier, is installed on Windows and Linux plug-in hosts.
