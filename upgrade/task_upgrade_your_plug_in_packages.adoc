...
* Ensure that ASP.NET Core Runtime 8.0.24 (and all subsequent 8.0.x patches) Hosting Bundle and PowerShell 7.4.13 or later is installed on the Windows plug-in host.
