...
+
Click image:../media/filter_icon.gif[filter icon], and then select the host name and the resource type to filter the resources. You can then click image:../media/filter_icon.png[Filter icon] to close the filter pane.
