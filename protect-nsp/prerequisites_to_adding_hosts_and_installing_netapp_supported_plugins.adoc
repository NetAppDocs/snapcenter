...
* You must have installed Java 17 (or Java 11 for SnapCenter 6.2) on your Linux, Windows, or AIX host.
+
...
+
If you are using Windows Server 2019 or Windows Server 2016 for the SnapCenter Server host, you must install Java 17 (or Java 11 for SnapCenter 6.2).
+
...
a|
Java 17 (or Java 11 for SnapCenter 6.2) IBM Java
