...
* You must have installed Java 17 (Oracle Java or OpenJDK) for SnapCenter 6.2.1 and later or
...
+
If you are using Windows Server 2019 or Windows Server 2016 for the SnapCenter Server host, you must install Java 17 (Oracle Java or OpenJDK) for SnapCenter 6.2.1 and later or Java 11 for SnapCenter 6.2 and earlier.
+
