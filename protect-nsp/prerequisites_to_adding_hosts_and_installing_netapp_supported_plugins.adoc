...
* You must have installed Java 17 (Oracle Java, OpenJDK, or SAP JDK) for SnapCenter 6.2.1 and later or Java 11 for SnapCenter 6.2 and earlier on your Linux, Windows, or AIX host.
+
...
+
link:https://www.oracle.com/java/technologies/downloads/#java17[Download Java for Windows]
...
* You must have installed Java 17 (Oracle Java, OpenJDK, or SAP JDK) for SnapCenter 6.2.1 and later or Java 11 for SnapCenter 6.2 and earlier on your Linux host.
+
If you are using Windows Server 2019 or Windows Server 2016 for the SnapCenter Server host, you must install Java 17 (Oracle Java, OpenJDK, or SAP JDK) for SnapCenter 6.2.1 and later or Java 11 for SnapCenter 6.2 and earlier.
+
link:https://www.oracle.com/java/technologies/downloads/#java17[Download Java for Linux]
+
...
a|
* Java 17 for SnapCenter 6.2.1 and later, IBM Java or Java 11 for SnapCenter 6.2 and earlier, IBM Java
