...
* You must have installed Java 17 (Oracle Java, OpenJDK, or SAP JDK) for SnapCenter 6.2.1 and later or
* Java 11 for SnapCenter 6.2 and earlier on your Linux, Windows, or AIX host.
+
...
a|
* Java 17 for SnapCenter 6.2.1 and later, IBM Java or
* Java 11 for SnapCenter 6.2 and earlier, IBM Java
