---
permalink: protect-postgresql/restore-and-recover-an-auto-discovered-database-backup.html
sidebar: sidebar
...
. In the Restore Scope page, select *Complete Resource* to restore the configured data volumes of the PostgreSQL database.
