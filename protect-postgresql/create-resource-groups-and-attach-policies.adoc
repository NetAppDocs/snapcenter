...
|===
+
NOTE: The custom key-value pairs are supported for PostgreSQL Linux plug-in systems and not supported for PostgreSQL database registered as a centralized windows plug-in.
