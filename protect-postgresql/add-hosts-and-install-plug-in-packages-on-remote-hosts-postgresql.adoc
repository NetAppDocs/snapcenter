...
+
link:../protect-postgresql/configure-gMSA-on-windows-server-2012-or-later.html[Configure group Managed Service Account on Windows Server 2016 or later for PostgreSQL]
