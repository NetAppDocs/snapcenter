...
+
----
C:\PS> New-SMBackup -ResourceGroupName 'ResourceGroup_wback-up-clusters-using-powershell-cmdlets-ibm-db2.adocith_SingleContainer_MultipleContainers_Resources'  -Policy db2_policy1
----
+
This example backs up a protected resource:
+
----
C:\PS> New-SMBackup -Resources @{"Host"="10.232.204.42";"Uid"="MDC\SID";"PluginName"="postgresql"} -Policy db2_policy2
----
