...
[.lead]
Automatic discovery is not supported on Windows host. You must add Postgresql instances and database resources manually.
...
After adding the databases, you can modify the PostgreSQL database details.
