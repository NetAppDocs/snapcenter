...
. Select the clones, and then click image:../media/delete_icon.gif[delete icon] to delete clones or click image:../media/split_cone.gif[split icon] to split the clones.
. Click *OK*.
