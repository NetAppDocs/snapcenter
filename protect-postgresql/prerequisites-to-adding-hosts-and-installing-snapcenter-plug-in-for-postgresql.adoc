...
* You must have installed Java 17 (for SnapCenter 6.2.1 and later) or Java 11 (for SnapCenter 6.2 and earlier) on your host.
+
...
* You must have installed Java 17 (for SnapCenter 6.2.1 and later) or Java 11 (for SnapCenter 6.2 and earlier) on your Windows host.
+
