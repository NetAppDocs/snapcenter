...
summary: 'SnapCenter integrates with the plug-in application and with NetApp technologies on the storage system. To work with the Plug-in for postgresql Database, you use the SnapCenter graphical user interface.'
---
...
[.lead]
SnapCenter integrates with the plug-in application and with NetApp technologies on the storage system. To work with the Plug-in for postgresql Database, you use the SnapCenter graphical user interface.
...
+
SnapCenter uses NetApp snapshot technology with the Plug-in for postgresql Database to back up resources.
