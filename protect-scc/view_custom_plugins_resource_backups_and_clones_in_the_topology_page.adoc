---
permalink: protect-scc/view_custom_plugins_resource_backups_and_clones_in_the_topology_page.html
sidebar: sidebar
...
---
= View custom plug-ins resource related backups and clones in the Topology page
:icons: font
:imagesdir: ../media/
