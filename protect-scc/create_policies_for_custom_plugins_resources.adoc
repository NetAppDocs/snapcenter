---
permalink: protect-scc/create_policies_for_custom_plugins_resources.html
sidebar: sidebar
...
See link:protect-nsp/view_custom_plugins_resource_backups_and_clones_in_the_topology_page.html[View custom plug-in resource related backups and clones in the Topology page].
a|
