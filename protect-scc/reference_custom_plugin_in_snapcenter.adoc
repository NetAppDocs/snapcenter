---
permalink: dev_guide/reference_custom_plugin_in_snapcenter.html
sidebar: sidebar
keywords:
...
For more information on how to upload the plug-in see, SnapCenter Software Installation and
Setup Guide.
