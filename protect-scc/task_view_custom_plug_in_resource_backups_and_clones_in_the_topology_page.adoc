...
+
NOTE: The number of backups displayed includes the backups deleted from the secondary storage. For example, if you have created 6 backups using a policy to retain only 4 backups, the number of backups displayed are 6.
...
link:task_back_up_resource_groups_of_custom_plug_in_resources.adoc[Back up resource groups of custom plug-in resources]
