...
link:task_create_policies_for_custom_plug_in_resources.adoc[Create policies for custom plug-in resources]

link:[Creating resource groups and attaching policies]

link:[Monitoring backup operations]

link:task_view_custom_plug_in_resource_backups_and_clones_in_the_topology_page.adoc[View custom plug-in resource related backups and clones in the Topology page]
