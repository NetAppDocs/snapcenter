...
link:task_create_policies_for_custom_plug_in_resources.html[Create policies for custom plug-in resources]

link:task_create_resource_groups_and_attach_policies.html[Creating resource groups and attaching policies]

link:task_monitor_scc_resources_backup_operations.html[Monitoring backup operations]

link:task_view_custom_plug_in_resource_backups_and_clones_in_the_topology_page.html[View custom plug-in resource related backups and clones in the Topology page]
