 ...
 ** xref:reference_prerequisites_to_adding_hosts_and_installing_snapcenter_custom_plug_ins.adoc[Prerequisites for adding hosts and installing SnapCenter Custom Plug-ins]
  ...
  *** xref:task_configure_gMSA_on_windows_server_2012_or_later_for_custom_applications.html.adoc[Configure group Managed Service Account on Windows Server 2012 or later for custom applications]
