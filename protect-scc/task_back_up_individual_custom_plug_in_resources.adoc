...
+
Click image:../media/filter_icon.png[], and then select the host name and the resource type to filter the resources. You can then click image:../media/filter_icon.png[] to close the filter pane.
