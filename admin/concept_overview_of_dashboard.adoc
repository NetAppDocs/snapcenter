...
Failed
a|
Primary: Count of entities that are part of a Resource Group, where the Resource Group has run a backup, but the backup failed.
a|
Secondary: Count of entities with backups that have failed to transfer to a Secondary destination.
a|
Successful
a|
Primary: Count of entities in a resource group, where the Resource Group has been successfully backed up.
a|
Secondary: Count of entities with backups that have been successfully transferred to a Secondary destination.
a|
Not configured
a|
Primary: Count of entities that are not part of any Resource Group and have not been backed up.
a|
...
Not initiated
a|
Primary: Count of entities that are part of a Resource Group, but no backup has been run.
a|
