...
** The default path of the MySQL PID directory is changed to custom path _/var/opt/mysqld_. Run the following commands to set the permissions for mysql installation.
