...
* CA certificates are required for LDAPS to provides end-to-end encryption during the active directory communication.
+
link:install/task_configure_CA_certificate_with_snapcenter_site.html[Configure CA certificate with SnapCenter site]
