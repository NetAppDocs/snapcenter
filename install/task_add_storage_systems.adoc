...
* You should set up the storage system such that SnapCenter can access Amazon FSx for NetApp ONTAP to perform data protection and provisioning operations.
+
You can either add FSx admin LIF comprising of multiple SVMs using fsxadmin account in SnapCenter 4.5 P1 or add FSx SVM in SnapCenter.
...
* Select *FSx* if you want to view all the clusters and SVMs that were added.
+
