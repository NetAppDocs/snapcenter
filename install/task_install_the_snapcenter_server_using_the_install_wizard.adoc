 ...
 ** ASP.NET Core 10.0.7 Hosting Bundle (or later)
 Refer to the link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467[SnapCenter Software Release Notes^] for the latest qualified versions of ASP.NET Core for your specific SnapCenter version.
