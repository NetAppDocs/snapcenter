...
SnapCenter Server also supports Multi-factor authentication (MFA) for domain account, which is part of the active directory.
...
NOTE: For Multi-factor authentication, only FQDN is supported.
