...
+
For information about the list of permissions, see link:task_create_an_ontap_cluster_role_with_minimum_privileges.html#ontap-cli-commands-for-creating-cluster-roles-and-assigning-permissions[ONTAP CLI commands for creating roles and assigning permissions^].
