...
+
Install .NET run time: `dnf install aspnetcore-runtime-8.0`
* PAM packages to support PAM authentication
+
Install PAM packages: `yum install pam-devel`
* PowerShell
+
Install PowerShell: `dnf install powershell`
