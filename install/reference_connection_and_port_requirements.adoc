...
When you are doing a fresh installation of SnapCenter 6.0 on Windows host or upgrade from earlier version, you should ensure that the scheduler port is open. the scheduler services run on the scheduler port.
