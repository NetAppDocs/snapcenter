...
For the latest information about supported versions, see https://imt.netapp.com/matrix/imt.jsp?components=116926;&solution=1517&isHWU&src=IMT[NetApp Interoperability Matrix Tool^].
