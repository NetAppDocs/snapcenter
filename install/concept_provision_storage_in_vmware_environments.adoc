...
== Related information
Refer to link:https://techdocs.broadcom.com[Broadcom Technical Documentation^] and search for documentation on clustering virtual machines across physical hosts and creating shared FC RDM LUNs for Microsoft clusters.
