...
sidebar: sidebar
keywords: svm role, privileges, asa r2
summary: 'You should create SVM roles if you configure SVMs in ASA r2 to use with SanpCenter and do not want to use the vsadmin role.'
---
= Create SVM roles for ASA r2 resources
:icons: font
:imagesdir: ../media/

[.lead]
There are several ONTAP CLI commands you must run to you create a role for a new SVM user in ASA r2. This role is required if you configure SVMs in ASA r2 to use with SnapCenter and you do not want to use the vsadmin role.
