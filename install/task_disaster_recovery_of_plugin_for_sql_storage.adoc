...
Partial disaster recovery is supported for a storage with resource group having resources, which are in disaster recovery mode and non-disaster recovery mode.
