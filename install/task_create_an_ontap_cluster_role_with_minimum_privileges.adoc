...
NOTE: Beginning with SnapCenter 5.0, cluster admin users are only supported with REST APIs. If you want to create roles using non cluster admin, you should use ZAPI.
