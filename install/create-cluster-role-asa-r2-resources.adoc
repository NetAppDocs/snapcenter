...
summary: 'You should create an ONTAP cluster roles for ASA r2 resurces so that you do not have to use the ONTAP admin role to perform operations in SnapCenter.'
---
