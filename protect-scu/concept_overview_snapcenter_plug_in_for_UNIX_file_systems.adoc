...
* Qtree restore is not supported.
* NFS file systems mounted on the host should have _.snapshot_ directory disabled during restore operation.
* SnapCenter CLIs are not supported for secondary clone and restore.